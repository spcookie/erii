...
[🚀 功能特性](#-功能特性) • [🏁 快速开始](#-快速开始) • [🛠️ 技术栈](#-技术栈) • [📦 构建与运行](#-构建与运行) • [📂 项目结构](#-项目结构) • [🗺️ 架构设计](#-架构设计)
...
| **MCP 工具** | 通过 Model Context Protocol 接入外部工具 | stdio / SSE / Streamable HTTP / WebSocket |
...
| 命令 | 说明 |
|:---|:---|
| `erii config` | 交互式 TUI 配置编辑器（env / app / plugin / souls / rules / mcp） |
