...
**主动意志**，能够像真人一样参与群聊对话，主动插话、破冰，并根据情绪状态调整说话风格。
...
2. **配置环境变量**
   ...
   MESSAGE_REDIRECT_MAP=1053148332_:474270623
   ```
...
- **[volition.md](doc/volition.md)** - 意志系统：冲动值计算、三大主动模式、抑制机制
...
4. **Agent 处理** → BotAgent 加载上下文（情绪、记忆、心流、意志）
