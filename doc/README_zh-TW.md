...
[🚀 功能特性](#-功能特性) • [🏁 快速開始](#-快速開始) • [🛠️ 技術堆疊](#-技術堆疊) • [📦 建置與執行](#-建置與執行) • [📂 專案結構](#-專案結構) • [🗺️ 架構設計](#-架構設計)
...
erii 是一個能像真人一樣參與群聊的 AI 機器人。它有情緒、有記憶、有性格——心情會隨對話起伏，說話風格也跟著變化。erii 不是被動等召喚，而是主動感知群裡的氛圍：該插話時插話，該安靜時安靜，冷場了還會自己找話題暖場。隨著聊天深入，erii 會記住每個群友的喜好，學會群裡的梗和黑話，越聊越有群裡的味道。此外，erii 支援定時提醒、自動總結聊天記錄，還可以透過規則檔案約束它的言行，透過 CLI 工具進行設定和資料管理。

**✨ 核心特性：**

- 🎭 **有情緒**：心情隨對話變化，開心時活潑，低落時安靜，說話風格跟著感覺走
- 🧠 **有記憶**：記住群友的喜好和說過的話，聊得越久越了解你
- 🌊 **懂分寸**：根據對話題的投入程度決定是否插話，該聊時聊，不該聊時不打擾
- ⚡ **會主動**：不只是等命令，感興趣的話題會主動加入，群冷了會自己暖場
- 📜 **守規矩**：透過 Markdown 規則檔案約束言行，不同群可以有不同的行為準則
- 📝 **能總結**：自動生成聊天摘要，幫你回顧錯過了什麼精彩內容
